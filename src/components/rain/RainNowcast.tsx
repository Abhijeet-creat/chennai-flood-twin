...
export default function RainNowcast() {
  ...
  async function runNowcast() {
    ...
    try {
      /*
       * Decode previous real IMD frame.
       */
      const previous =
        await decodeFrame(
          PREVIOUS_IMAGE,
      ...
      /*
       * Generate the 0–3 hour forecast.
       */
      const forecast =
        createRainfallNowcast(
          previousFrame,
  ...
  return (
    <div className="min-h-screen overflow-y-auto bg-[#071522] px-6 py-8 text-white">
      ...
      <div className="mx-auto w-full max-w-6xl">
        ...
        <div className="mb-7">
          ...
          <p className="mt-2 max-w-4xl text-sm leading-6 text-white/50">
            Real IMD Chennai radar observations are used
            to estimate rainfall movement and generate a
            forward rainfall forecast.
          </p>
        ...
        {error && (
          <section className="mt-5 rounded-2xl border border-red-400/20 bg-red-400/5 p-5">
            ...
            <div className="mt-4 rounded-xl bg-black/20 p-4 font-mono text-xs leading-6 text-white/45">
            ...
            <div className="mt-6 space-y-5">
              ...
              <section className="grid grid-cols-2 gap-3 md:grid-cols-4">
                ...
                <Metric
                  ...
                  value={`${radarIntervalMinutes} min`}
                />
                  ...
                  <table className="w-full min-w-[620px] border-collapse">
                    ...
                    <thead>
                      ...
                      <tr className="border-b border-white/10">
                        ...
                        <th className="px-3 py-3 text-left text-[10px] uppercase tracking-wider text-white/30">
                          Lead
                        </th>
